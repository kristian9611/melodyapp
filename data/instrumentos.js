const instrumentos = {
  ...
  Correa: {
    ...
    descripcion:
      "¿Quieres darle un tono más variado a tu correa? Entonces esta correa te ayuda en ello. Con diseños rockeros e interesantes, este producto te ofrece una variedad de estilos para que puedas elegir cuál combina mejor con tu estilo",
    precio: "USD 62",
  ...
  PedalMultiefectos2: {
    titulo: "Pedalera/pedal Multiefectos Marca Mooer Ge300",
    descripcion:
  ...
  GuitarraFolk: {
    ...
    descripcion:
      "Tapa de abeto Forma del cuerpo: dreadnought El largo de escala es 643mm  Tiene 6 cuerdas de metal Guitarra versátil que se adapta a una gran variedad de estilos musicales",
    precio: "USD 325",
  ...
  BajoFender: {
    titulo: "Bajo Electrico Sq Cv 70s Jazz Bass Mn Nat374540521fender",
    descripcion:
